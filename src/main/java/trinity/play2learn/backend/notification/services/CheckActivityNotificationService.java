...
import trinity.play2learn.backend.notification.services.interfaces.ICheckActivityNotificationService;
import trinity.play2learn.backend.notification.services.interfaces.ICreateUsersNotifications;
import trinity.play2learn.backend.user.models.User;

@Service
@AllArgsConstructor
public class CheckActivityNotificationService implements ICheckActivityNotificationService {
