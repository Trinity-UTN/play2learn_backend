...
@RestController
@AllArgsConstructor
public class SavingAccountListPaginatedController {

    private final ISavingAccountListPaginatedService savingAccountListPaginatedService;

    @GetMapping("/paginated")
    @SessionRequired(roles = {Role.ROLE_STUDENT})
    public ResponseEntity<BaseResponse<PaginatedData<SavingAccountResponseDto>>> listPaginated(
