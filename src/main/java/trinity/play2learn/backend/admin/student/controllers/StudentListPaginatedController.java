...
@RestController
@AllArgsConstructor
public class StudentListPaginatedController {

    private final IStudentListPaginatedService studentListPaginatedService;

    @GetMapping("/paginated")
    @SessionRequired(roles = {Role.ROLE_ADMIN})
    public ResponseEntity<BaseResponse<PaginatedData<StudentResponseDto>>> listPaginated(
        ...
        return ResponseFactory.paginated(studentListPaginatedService.cu21ListPaginatedStudents(page, pageSize, orderBy, orderType, search, filters, filtersValues), "Ok");
    }
